...
public class DoubleMultiSet {
    ...
    private DoubleMultiSet(double[] values, double[] counts){
        int zeros = VectorUtils.occurences(counts, 0);
     ...
     * When there are multiplicities in the given array, they will be taken into account
     * (multi-sets keep track of the numbers of copies of each element in them).
     * 
     ...
     * Multiplicities of the numbers in the multi-set are taken from the given Counters<Double> object.
     * 
     ...
     * of elements in this DoubleMultiSet by the given number.
    ...
    /**
     * Computes intersection of the DoubleNultiSets in the given collection.
     * @param sets the collection of DoubleMultiSets
     * @return the  intersection of the DoubleNultiSets in the given collection
     */
    ...
    /**
     * Computes intersection of the DoubleNultiSets in the given array.
     * @param sets the array of DoubleMultiSets
     * @return the intersection of the DoubleNultiSets in the given array
     */
    ...
    /**
     * Computes union of the DoubleNultiSets in the given collection.
     * @param sets the collection of DoubleMultiSets
     * @return the union of the DoubleNultiSets in the given collection
     */
    ...
    /**
     * Computes union of the DoubleNultiSets in the given array.
     * @param sets the array of DoubleMultiSets
     * @return the union of the DoubleNultiSets in the given array
     */
    ...
    /**
     * Counts the number of non-empty DoubleMultiSets in the given array.
     * @param sets the array of DoubleMultiSets
     * @return the number of non-empty DoubleMultiSets in the given array.
     */
    ...
    /**
     * Counts the number of empty DoubleMultiSets in the given array.
     * @param sets the array of DoubleMultiSets
     * @return the number of empty DoubleMultiSets in the given array.
     */
    ...
    /**
     * Counts the number of non-empty DoubleMultiSets in the given array w.r.t. the given mask.
     * @param sets the array of DoubleMultiSets
     * @param the mask denoting which DoubleMNultiSets from the array should be considered
     * @return the number of non-empty DoubleMultiSets in the given array.
     */
    public static int countNonEmpty(DoubleMultiSet[] sets, boolean[] mask){
        int count = 0;
        int i = 0;
        for (DoubleMultiSet is : sets){
    ...
    /**
     * Counts the number of empty DoubleMultiSets in the given array w.r.t. the given mask.
     * @param sets the array of DoubleMultiSets
     * @param the mask denoting which DoubleMNultiSets from the array should be considered
     * @return the number of empty DoubleMultiSets in the given array.
     */
    public static int countEmpty(DoubleMultiSet[] sets, boolean[] mask){
        int count = 0;
        int i = 0;
        for (DoubleMultiSet is : sets){
            if (mask[i] && is.isEmpty()){
     ...
     * @param d the number for which we check if it is present in the DoubleMultiSet
    ...
    /**
     * @return the array of values in this DoubleMultiSet
     */
    ...
    /**
     * 
     * @return number of elements in this DoubleMultiSet
     */
    public int size(){
