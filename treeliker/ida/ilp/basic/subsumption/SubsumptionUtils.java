...
public class SubsumptionUtils {
    ...
    /**
     * Computes neighbours of given iteral in a given clause (neighbours are literals 
     * which share with the given literal at least one term - beware this can result in
     ...
     * @param c the clause in which we want to find the neighbours
     ...
     * @return pair: cyclic part of the clause (which cannot be decomposed) and decomposition of the clause in the form of joins (represented as pairs of literals)
     */
     ...
     * Computes GYO-decomposition of the given clause.
     * @param c the clause for which we want to find the decomposition
     * @return decomposition of the clause in the form of joins (represented as pairs of literals)
     */
